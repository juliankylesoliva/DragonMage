...
func throw_projectile():
	if (projectile_instance == null):
		...
		throw_offset.x *= (-1 if hub.state_machine.current_state.name == "WallSliding" or hub.collisions.is_facing_a_wall() else 1)
		...
		throw_direction.x *= (-1 if hub.state_machine.current_state.name == "WallSliding" or hub.collisions.is_facing_a_wall() else 1)
