...
public class PlayerCamera : MonoBehaviour
{
    ...
    {
        if (player.form.isChangingForm || player.attacks.currentAttackState == AttackState.STARTUP || ((player.collisions.IsGrounded || player.collisions.IsOnASlope) && player.attacks.currentAttackState == AttackState.ENDLAG) || player.stateMachine.CurrentState == player.stateMachine.frozenControlState) { return; }
